...
export const Faq = () => {
  const faqs = [
    {
      id: 1,
      question: "Why should I use ProgBook?",
      answer:
  ...
  return (
    <section className="my-10 border rounded shadow-sm p-7 dark:border-slate-700">
      <h1 className="mb-3 text-2xl font-semibold text-center underline dark:text-slate-100 underline-offset-8 decoration-from-font">
        Question in mind?
      </h1>
      <div
        className=""
