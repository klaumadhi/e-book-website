...
export const Login = () => {
  ...
  async function handleLoginGuest(){
    email.current.value = "klaurent@example.com"
    password.current.value = "Klaurent123"
    try{
